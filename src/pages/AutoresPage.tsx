              ...
              <div className="relative z-10">
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="flex justify-center space-x-4">
                    <a href={`https://instagram.com/${autor.redes.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="text-pink-500 hover:text-pink-600 transition-colors">
                    ...
                    <a href={`https://facebook.com/${autor.redes.facebook}`} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 transition-colors">
                    ...
                    <a href={`mailto:${autor.redes.email}`} className="text-gray-500 hover:text-gray-600 transition-colors">
