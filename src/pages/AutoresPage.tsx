      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-16 animate-fade-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-gray-800 mb-4 sm:mb-6">
            Autores del 6to Ciclo y 5to Ciclo
          </h2>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
            Conoce a los talentosos estudiantes que han contribuido con sus
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {autores.map((autor, index) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-br ${autor.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
              ></div>
              ...
              <div className="relative z-10">
                <div className="flex flex-col items-center mb-4 sm:mb-6">
                  <div className="relative mb-4">
                    ...
                    />
                    <div
                      className={`absolute inset-0 rounded-full bg-gradient-to-br ${autor.color} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                    ></div>
                  </div>
                  ...
                  <span
                    className={`bg-gradient-to-r ${autor.color} text-white px-3 py-1 rounded-full text-xs sm:text-sm font-medium shadow-lg`}
                  >
                    {autor.especialidad}
                  </span>
                </div>
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="flex justify-center space-x-4">
                    <a
                      href={`https://instagram.com/${autor.redes.instagram.replace(
                        "@",
                        ""
                      )}`}
                      target="_blank"
                    ...
                    <a
                      href={`https://facebook.com/${autor.redes.facebook}`}
                      target="_blank"
                      rel="noopener noreferrer"
